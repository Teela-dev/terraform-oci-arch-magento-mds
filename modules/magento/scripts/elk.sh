...
then
	...
	yum install -y ${elastic_search_download_url}-${elastic_search_download_version}-aarch64.rpm
	# Install Kibana
	...
	# Install Elasticsearch
	yum install -y ${elastic_search_download_url}-${elastic_search_download_version}-x86_64.rpm
	# Install Kibana
